...
# Modification: [rm and add some connect adapter to match with NeuroVLA, e.g., "rm "].
...
from NeuroVLA.model.modules.action_model.flow_matching_head.action_encoder import (
    SinusoidalPositionalEncoding,
    swish,
)

from NeuroVLA.model.modules.action_model.flow_matching_head.cross_attention_dit import DiT, SelfAttentionTransformer
