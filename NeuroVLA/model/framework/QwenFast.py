...
from NeuroVLA.model.modules.action_model.fast_ActionHeader import get_action_model
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="./NeuroVLA/config/training/internvla_cotrain_oxe.yaml", help="Path to YAML config")
