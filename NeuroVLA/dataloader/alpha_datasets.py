...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="/workspace/llavavla0/playground/Checkpoints/1026_spikevla_xiaonao_spkieaction/config.yaml", help="Path to YAML config")
    ...
    # path = "/workspace/dataset/pickandplacecup_head/aftertransfer/meta/steps_fa5c4d6f04e5.pkl"
    ...
    #     for k in list(data.keys())[:10]:  # 打印前10个键
    #         print(k,data[k])
    # exit()
    cfg = OmegaConf.load(args.config_yaml)
    cfg.datasets.vla_data.dataset_py="alpha_datasets"
    cfg.datasets.vla_data.data_root_dir="/workspace/dataset/pickandplacecup_head"
    cfg.datasets.vla_data.data_mix="alphabot"
